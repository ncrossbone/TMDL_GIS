...
<script type="text/javascript" src="http://map.vworld.kr/js/apis.do?type=Base&apiKey=FE124A70-F97D-302C-B3FB-E1F918F0C748"></script>
...
<%
	if( ie9 ) {
%>
<script type="text/javascript" src="resources/js/data/CommonData_EUCKR.js" charset="UTF-8"></script>
<%
	} else {
%>
...
function getLayerUrl(){
	return "http://211.114.21.39:80/geoserver/tmdl/wms";
